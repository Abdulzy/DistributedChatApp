...
public class DiscussionPan extends JPanel {
	...
	public DiscussionPan() {
		...
		tabbeClient.addTab("    Connected ... ", new ChatPan());
		tabbeClient.setSelectedIndex(0);
		tabbeClient.setFont(new Font("Tahoma", Font.BOLD, 16));
		tabbeClient.setBackground(new Color(24, 43, 53));
	...
	public void fillMain() {
		...
		JButton ValidButton = new JButton(Manager.getImg("img/valid.png", 90, 45));
