...
public class View extends JFrame {
	...
	public static DiscussionPan discussionPan;
	public static CommunityChat communityChat;
	...
	public View() {
		...
		setUndecorated(true);
		setResizable(true);
		setIconImage(Manager.getImg("img/chat5.png", 650, 650).getImage());
	...
	private void FillBar() {
		...
		JLabel iconLabel = new JLabel("     Chat", Manager.getImg("img/chat5.png", 30, 25), 2);
	...
	private void FillPanel() {
		...
		tabbePane.setBackground(new Color(24, 43, 53));
		tabbePane.setForeground(Color.black);
		tabbePane.setFocusable(true);
		tabbePane.validate();

		inter.add(tabbePane);
		inter.setBackground(new Color(18, 33, 43));
	...
	public void setBarButton() {
		exitButton.setIcon(Manager.getImg("img/exit.png", 30, 30));
		ReduireButton.setIcon(Manager.getImg("img/reduir.png", 30, 30));
	}
